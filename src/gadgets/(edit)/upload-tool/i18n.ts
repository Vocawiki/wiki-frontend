...
const MESSAGES = {
	...
	'err-badfilename': tr('文件名已被自动改为：$1', '檔案名稱已被自動改為：$1'),
	'err-was-deleted': tr(
		'同名文件 $1 曾被删除，如需重建请勾选“忽略所有警告”。',
		'同名檔案 $1 曾被刪除，如需重建請勾選「忽略所有警告」。',
	),
	'err-duplicate-archive': tr(
		'同一文件名的归档已存在（$1 历史曾被删除），如需覆盖请勾选“忽略所有警告”。',
		'同一檔案名稱的歸檔已存在（$1 歷史曾被刪除），如需覆蓋請勾選「忽略所有警告」。',
	),
	'err-exists-normalized': tr(
		'文件名规范化后与 $1 冲突，请改名或勾选“忽略所有警告”。',
		'檔案名稱規範化後與 $1 衝突，請改名或勾選「忽略所有警告」。',
	),
	'err-duplicate': tr(
		'相同内容的文件 $1 已存在，如需覆盖请勾选“忽略所有警告”。',
		'相同內容的檔案 $1 已存在，如需覆蓋請勾選「忽略所有警告」。',
	),
