...
export function FlashTopic() {
	...
	return (
		...
		>
			<div className="fill ignore-article-inline-padding bg-[#cfd4ff] bg-[image:url(/images/5/57/The_VOCALOID_Collection_2026_Summer_KV.webp)] bg-size-[100%_100%] bg-fixed bg-center" />
